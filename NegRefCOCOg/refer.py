		...
		if seg_box == 'seg':
			...
			if type(ann['segmentation'][0]) == list:
				...
				for seg in ann['segmentation']:
					...
					color.append(c)
				p = PatchCollection(polygons, facecolors='none', edgecolors=(1,1,0,0), linewidths=3, alpha=1)
				ax.add_collection(p)  # thick yellow polygon
				p = PatchCollection(polygons, facecolors='none', edgecolors=(1,0,0,0), linewidths=1, alpha=1)
